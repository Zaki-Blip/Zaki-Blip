...
- 🏴‍☠️ **One Piece** fan — currently rewatching the Wano arc
...
## 🎥 Project Demo — LastUSK

> ⚠️ Catatan: GitHub tidak mengizinkan video auto-play langsung di halaman README (tag `<video>`/`<iframe>` diblokir demi keamanan). Klik thumbnail di bawah untuk nonton — video akan otomatis play begitu sampai di YouTube.

[![LastUSK Demo](https://img.youtube.com/vi/u9PKH9fVNqI/0.jpg)](https://www.youtube.com/watch?v=u9PKH9fVNqI&autoplay=1)

▶️ **[Watch the full demo](https://www.youtube.com/watch?v=u9PKH9fVNqI&autoplay=1)**

💡 *Kalau tetap mau ada sesuatu yang bergerak otomatis pas profil dibuka, ganti bagian ini dengan GIF pendek dari video kamu — GIF di README GitHub otomatis play tanpa diklik. Bilang aja kalau mau aku bantu convert video ke GIF.*
